...
@section('title', 'Tambah Background Landing')
...
<div class="space-y-8">
    <div class="flex items-center">
        ...
        <h1 class="text-3xl font-bold text-gray-800">Tambah Background Landing</h1>
    </div>

    <div class="bg-white p-6 sm:p-8 rounded-xl shadow-xl">
        <form action="{{ route('admin.landing-background.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            
            <div class="space-y-6">
                <!-- Upload Image -->
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Gambar Background *</label>
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-indigo-400 transition-colors">
                        ...
                        <div id="upload-placeholder">
                            ...
                            <p class="text-gray-600 mb-1">Klik untuk upload gambar atau drag & drop</p>
