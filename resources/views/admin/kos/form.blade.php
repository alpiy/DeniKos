    ...
    <div>
        ...
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-3">
                ...
                <input type="text" name="nomor_kamar" id="nomor_kamar" value="{{ old('nomor_kamar', $kos->nomor_kamar ?? '') }}" required
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('nomor_kamar')  @enderror"
                       placeholder="Contoh: 101, A05">
            ...
            <div class="sm:col-span-3">
                ...
                <select id="lantai" name="lantai" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('lantai')  @enderror">
            ...
            <div class="sm:col-span-3">
                ...
                <input type="number" name="harga_bulanan" id="harga_bulanan" value="{{ old('harga_bulanan', $kos->harga_bulanan ?? '') }}" required min="0"
                       class="mt-1 block w-full rounded-md  shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('harga_bulanan') border-red-500 @enderror"
            ...
            <div class="sm:col-span-3">
                ...
                <select id="status_kamar" name="status_kamar" required
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('status_kamar')  @enderror">
             ...
             <div class="sm:col-span-3">
                ...
                <input type="text" name="luas_kamar" id="luas_kamar" value="{{ old('luas_kamar', $kos->luas_kamar ?? '2x3') }}"
                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('luas_kamar') @enderror"
        ...
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-6">
                ...
                <textarea id="alamat" name="alamat" rows="3" required
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('alamat')  @enderror"
            ...
            <div class="sm:col-span-6">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4"
                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('deskripsi')  @enderror"
            ...
            <div class="sm:col-span-6">
                ...
                <input type="text" name="fasilitas" id="fasilitas"
                       ...
                       required
                       class="mt-1 block w-full rounded-md  shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('fasilitas') border-red-500 @enderror"
