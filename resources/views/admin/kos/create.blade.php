...
@section('title', 'Tambah Kamar Kos Baru')

@section('content')
<div class="space-y-8">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Kamar Kos Baru</h1>
            <p class="mt-1 text-sm text-gray-500">Isi detail informasi untuk kamar kos yang akan ditambahkan.</p>
        </div>
